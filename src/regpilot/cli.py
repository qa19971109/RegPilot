...
def load_config(args: argparse.Namespace) -> RegisterConfig:
    ...
    cfg = RegisterConfig(
        ...
        hero_sms_wait_timeout=int(data.get("hero_sms_wait_timeout") or cfg.hero_sms_wait_timeout),
        hero_sms_wait_interval=int(data.get("hero_sms_wait_interval") or cfg.hero_sms_wait_interval),
        hero_sms_auto_retry=parse_bool(data.get("hero_sms_auto_retry", cfg.hero_sms_auto_retry), default=cfg.hero_sms_auto_retry, key="hero_sms_auto_retry"),
        hero_sms_retry_count=max(1, int(data.get("hero_sms_retry_count") or cfg.hero_sms_retry_count)),
